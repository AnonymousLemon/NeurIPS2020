function [f,g,H] = invexFunReg01(x,A, regFun)
if nargin==0
    tic;
    runTest
    toc;
...
n = 10;
A = randn(n,p);
derivativeTest(@(x) invexFunReg01(x,A),randn(p,1))
...
for i = 1:length(x1)
    [f1(i),g1(i),Hv1] = invexFunReg01(x1(i),1);
    H1(i) = Hv1(1);
end
...
for i = 1:length(x2)
    [f2(i),g2(i),Hv2] = invexFunReg01(x2(i),1);
    H2(i) = Hv2(1);
end
...
for i = 1:length(x3)
    [f3(i),g3(i),Hv3] = invexFunReg01(x3(i),1);
    H3(i) = Hv3(1);
end
...
plot(-2, invexFunReg01(-2,1), 'g.', 'MarkerSize',27);
...
dir_name = './results/exampleFunction01';
